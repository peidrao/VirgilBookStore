...
class ContactMessageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'name':  forms.TextInput(attrs={'class': 'form-control', 'type': 'text', 'placeholder': 'Seu nome', 'required': True}),
            'email':  forms.TextInput(attrs={'class': 'form-control', 'type': 'email', 'placeholder': 'Seu e-mail', 'required': True}),
